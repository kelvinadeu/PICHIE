...
class Submount(RuleFactory):
    ...
    """Like `Subdomain` but prefixes the URL rule with a given string::
        ...
        url_map = Map([
            Rule('/', endpoint='index'),
            Submount('/pitchie', [
                Rule('/', endpoint='pitchie/index'),
                Rule('/entry/<entry_slug>', endpoint='pitchie/show')
            ])
        ])

    Now the rule ``'pitchie/show'`` matches ``/pitchie/entry/<entry_slug>``.
    """
...
class EndpointPrefix(RuleFactory):
    ...
    another string. This can be useful for sub applications::
        ...
        url_map = Map([
            Rule('/', endpoint='index'),
            EndpointPrefix('pitchie/', [Submount('/pitchie', [
                Rule('/', endpoint='index'),
